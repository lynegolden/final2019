...
The Fisher test is rejected because the p-value is < 2.998e-06 and we know the correct number is more than the p-value should be, therefore, our hypothesis on the fisher test is null.

# Discussion and Conclusion
  
We conclude, that our hypothesis is null and that looking at all the charts: chi-square curve, fisher test, barchart, the column and the row, which tells us the evidence of IVdrug users that is infected with aids and taking the drugs is the highest and therefore, the treatment wasn't working for the IVdrug users. However, the IVdrug users infected with aids and taking the placebo had the lowest results that lets us know that the treatment was working. Also, the IVdrug users not infected and taking the drugs and not infected and taking the placebo was exactly the same on some  numbers and on the barchart that lets us know these two in the treatment didn't work either.  
